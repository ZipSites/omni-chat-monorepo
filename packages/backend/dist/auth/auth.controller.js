...
let AuthController = class AuthController {
    ...
    async registerUser(registerUserDto) {
        console.log('AuthController: Received register_user message with payload (email only):', registerUserDto.email);
        return this.authService.register(registerUserDto);
    }
    async loginUser(loginUserDto) {
        console.log('AuthController: Received login_user message with payload (email only):', loginUserDto.email);
